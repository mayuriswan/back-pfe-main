...
namespace API_Iresen.Migrations
{
    ...
    [Migration("20240713134831_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Iresen.Models.Evaluation", b =>
                {
                    ...
                    b.Property<List<int>>("EvaluatorIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("API_Iresen.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_Iresen.Models.ReviewCriteria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_Iresen.Models.ReviewForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ProjectEvaluator", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ProjectEvaluators", (string)null);
                });
            ...
            modelBuilder.Entity("API_Iresen.Models.Project", b =>
                {
                    ...
                    b.HasOne("API_Iresen.Models.ReviewForm", "ReviewForm")
                        .WithMany()
            ...
            modelBuilder.Entity("API_Iresen.Models.Review", b =>
                {
                    ...
                    b.HasOne("API_Iresen.User", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("API_Iresen.Models.ReviewCriteria", b =>
                {
                    b.HasOne("API_Iresen.Models.ReviewForm", null)
                        .WithMany("Criteria")
                        .HasForeignKey("ReviewFormId");

                    b.HasOne("API_Iresen.Models.Review", "Review")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectEvaluator", b =>
                {
                    b.HasOne("API_Iresen.Models.Project", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_ProjectEvaluator_Project");
                    ...
                    b.HasOne("API_Iresen.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ProjectEvaluator_User");
                });
