...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Iresen.Models.EvaluationNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_Iresen.Models.EvaluationNoteCriterion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("EvaluationNoteId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("EvaluationNoteId");

                    b.ToTable("EvaluationNoteCriteria");
                });
            ...
            modelBuilder.Entity("API_Iresen.Models.EvaluationCriterion", b =>
                {
                    b.HasOne("API_Iresen.Models.Evaluation", null)
                        .WithMany("Criteria")
            ...
            modelBuilder.Entity("API_Iresen.Models.EvaluationNote", b =>
                {
                    b.HasOne("API_Iresen.User", "Evaluator")
                        .WithMany()
            ...
            modelBuilder.Entity("API_Iresen.Models.EvaluationNoteCriterion", b =>
                {
                    b.HasOne("API_Iresen.Models.EvaluationNote", "EvaluationNote")
                        .WithMany("CriteriaNotes")
                        .HasForeignKey("EvaluationNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EvaluationNote");
                });
